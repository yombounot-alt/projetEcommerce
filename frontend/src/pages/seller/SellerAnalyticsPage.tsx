...
export default function SellerAnalyticsPage() {
  ...
  if (isLoading || !data)
    return <LoadingState className="min-h-[50vh]" label="Chargement des statistiques…" />;
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Commandes par jour (30 derniers jours)</CardTitle>
        </CardHeader>
            ...
            <BarChart data={data.revenueSeries}>
              ...
              <XAxis
                ...
                tickFormatter={(value: string) =>
                  formatDate(value, { day: "2-digit", month: "2-digit", year: undefined })
                }
              ...
              <Tooltip
                formatter={(value, name) =>
                  name === "revenue" ? formatPrice(Number(value ?? 0)) : String(value ?? "")
                }
