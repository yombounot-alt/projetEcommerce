...
import { ProductVariantsField } from "@/features/products/components/ProductVariantsField";
  ...
  useEffect(() => {
    if (existingProduct) {
      form.reset({
        ...
        variantOptions: existingProduct.variantOptions,
                  ...
                  <FormItem>
                    <FormControl>
                      <ProductVariantsField
                        variantOptions={form.watch("variantOptions") ?? []}
                        variants={field.value ?? []}
                        onChange={({ variantOptions, variants }) => {
                          form.setValue("variantOptions", variantOptions);
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="SKU-EXAMPLE-001" {...field} disabled={isEditing} />
                    </FormControl>
                    {isEditing && (
                      <p className="text-xs text-muted-foreground">
                        Le SKU ne peut pas être modifié après création.
                      </p>
                    )}
                    <FormMessage />
                  </FormItem>
            ...
            <CardContent className="space-y-4 p-6">
              <div className="grid grid-cols-2 gap-3">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Prix barré (GNF)</FormLabel>
                      <FormControl>
                        <Input
                          type="number"
                          step="0.01"
